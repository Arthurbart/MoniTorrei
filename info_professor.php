    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <ul class="nav nav-tabs" id="monitoriaTabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="arquivos-tab" data-bs-toggle="tab" data-bs-target="#arquivos" type="button" role="tab" aria-controls="arquivos" aria-selected="false">Lista de Presença</button>
          </li>
        </ul>
